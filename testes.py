...
def correr_todos_os_testes():
    ...
    print("Grelha Inicial:")
    print_grelha(grelha_teste)
    
    gol_seq = game_of_life_sequential(grelha_teste, 1)
    print("Grelha após 1 Geração:")
    ...
    gol_par = game_of_life_parallel(grelha_teste, 1, workers)
    print("Grelha após 1 Geração:")
